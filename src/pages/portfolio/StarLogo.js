...
class StarLogo extends CustomComponent
{
    render()
    {
        return (
            ...
            >
                <PageHeader>
                    Master's Thesis:<Space size='xs'/><i>Custom and Interactive Environments in {CONSTANTS.NAMES.STARLOGO} for Computational Modeling</i>
                </PageHeader>
                <Typography>
                ...
                <Space size='sm'/>
                <Typography>
                    For my master's thesis, I created a game engine sub-system for <i>{CONSTANTS.NAMES.STARLOGO}</i> that renders dynamic, 3D terrain. I also   
                    designed a suite of interactive tools that allow users to create a variety of environments by editing the underlying grid of terrain 
